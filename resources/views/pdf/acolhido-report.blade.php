...
<head>
    <meta charset="utf-8">
    <title>Relatorio institucional do acolhido</title>
    <style>
            ...
            <table class="hero-table">
                <tr>
                    ...
                    <td>
                        ...
                        <h1>Relatorio institucional do acolhido</h1>
            ...
            <tr>
                ...
                <td>
                    <div class="summary-card">
                        ...
                        <span class="summary-value">{{ $selectedSectionsCount === $availableSectionsCount ? 'Completo' : 'Selecao parcial' }}</span>
