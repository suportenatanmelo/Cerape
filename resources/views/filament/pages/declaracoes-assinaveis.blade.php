<x-filament-panels::page>
    <style>
        ...
        .dark .declaration-panel,
        .dark .declaration-preview {
            background: linear-gradient(180deg, rgba(15, 23, 42, 0.96), rgba(15, 23, 42, 0.92));
            border-color: rgba(71, 85, 105, 0.55);
            box-shadow: 0 18px 40px rgba(2, 6, 23, 0.35);
        }

        .dark .declaration-panel .fi-input-wrp,
        .dark .declaration-panel .fi-dropdown-panel,
        .dark .declaration-panel .fi-select-input-search-ctn {
            background: #ffffff !important;
            border-color: rgba(15, 23, 42, 0.14) !important;
        }

        .dark .declaration-panel select,
        .dark .declaration-panel select option,
        .dark .declaration-panel select optgroup,
        .dark .declaration-panel .fi-select-input,
        .dark .declaration-panel .fi-select-input-btn,
        .dark .declaration-panel .fi-select-input-option,
        .dark .declaration-panel .fi-select-input-value-label,
        .dark .declaration-panel [data-slot="input"],
        .dark .declaration-panel .choices__inner,
        .dark .declaration-panel input {
        ...
        .dark .declaration-panel .fi-select-input-placeholder,
        .dark .declaration-panel input::placeholder {
