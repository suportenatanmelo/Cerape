...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('homes', function (Blueprint $table): void {
            ...
            $table->string('about_image', 512)->nullable()->after('about_subtitle');
            ...
            $table->string('projects_image', 512)->nullable()->after('projects_subtitle');
            ...
            $table->string('signup_image', 512)->nullable()->after('signup_subtitle');
