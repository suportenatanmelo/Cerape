...
class CmsContentHelper
{
    public static function helperText(?string $type = null): string
    {
        return match ($type) {
            ...
            CmsContent::TYPE_NEWS => 'Cadastre notícias institucionais no mesmo padrão editorial do blog.',
            CmsContent::TYPE_EVENT => 'Cadastre eventos com data, imagem, mapa e link de inscrição.',
