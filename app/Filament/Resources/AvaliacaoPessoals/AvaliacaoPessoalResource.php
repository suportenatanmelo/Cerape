            ...
            ->map(function ($avaliacoesDoUsuario) {
                ...
                return [
                    ...
                    'criterios' => [
                        ...
                        'Transparência' => (float) $avaliacoesDoUsuario->avg('transparencia'),
                        'Superação' => (float) $avaliacoesDoUsuario->avg('superacao'),
        ...
        if ($usersWhoEvaluated->isNotEmpty()) {
            FilamentDatabaseNotifications::send(
                Notification::make()
                    ...
                    ->body("O acolhido {$avaliacao->acolhido->nome_completo_paciente} já possui média de todos: " . self::formatScore(self::calculateMediaDeTodos($avaliacao->acolhido_id)) . '.')
                    ->success()
