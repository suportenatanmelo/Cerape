<div class="space-y-5">
    <div class="grid gap-3 md:grid-cols-4">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="mt-1 text-2xl font-semibold text-gray-950 dark:text-white">
                <?php echo e(number_format((float) $somaMediasIndividuais, 2, ',', '.')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                <div class="flex flex-col gap-4 border-b border-gray-200 bg-gray-50 p-5 dark:border-gray-800 dark:bg-gray-950/60 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['foto']): ?>
                            <img src="<?php echo e($item['foto']); ?>" alt="" class="h-12 w-12 rounded-full object-cover">
                        <?php else: ?>
                        ...
                        <div>
                            <div class="font-semibold text-gray-950 dark:text-white">
                                <?php echo e($item['user']?->name ?? 'Profissional nao informado'); ?>

                            </div>
                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                <?php echo e($item['user']?->email ?? 'Sem e-mail cadastrado'); ?>
                    ...
                    <div class="grid gap-3 sm:grid-cols-3">
                        <div class="rounded-xl bg-white px-4 py-3 text-center shadow-sm dark:bg-gray-900">
                            ...
                            <div class="mt-1 text-lg font-semibold text-gray-950 dark:text-white"><?php echo e($item['quantidade']); ?></div>
                        </div>

                        <div class="rounded-xl bg-white px-4 py-3 text-center shadow-sm dark:bg-gray-900">
                            <div class="text-xs uppercase tracking-wide text-gray-500">Media individual</div>
                            <div class="mt-1 text-lg font-semibold text-gray-950 dark:text-white"><?php echo e($formatScore((float) $item['media'])); ?></div>
                        </div>
                        ...
                        <div class="rounded-xl bg-white px-4 py-3 text-center shadow-sm dark:bg-gray-900">
                            ...
                            <div class="mt-1 text-sm font-semibold text-gray-950 dark:text-white">
                                <?php echo e($item['ultima_avaliacao']?->created_at?->format('d/m/Y H:i') ?? '-'); ?>
                ...
                <div class="grid gap-4 p-5 lg:grid-cols-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $item['criterios']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-950">
                            ...
                            <div class="mt-2 text-xl font-semibold text-gray-950 dark:text-white">
                                <?php echo e($formatScore((float) $media)); ?>
