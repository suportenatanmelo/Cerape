...
<head>
    <meta charset="utf-8">
    <title><?php echo e($payload['title']); ?></title>
    <style>
...
<body>
    <div class="page">
        ...
        <div class="document-shell">
            <?php echo $__env->make('declaracoes.partials.documento', ['payload' => $payload, 'mode' => 'pdf'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php /**PATH C:\laragon\www\cerape\resources\views/pdf/declaracoes-assinaveis.blade.php ENDPATH**/ ?>