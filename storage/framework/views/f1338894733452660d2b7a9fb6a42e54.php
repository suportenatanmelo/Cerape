...
<head>
    <meta charset="utf-8">
    <title><?php echo e($record->titulo); ?></title>
    <style>
...
<body>
    <div class="page">
        ...
        <div class="header">
            ...
            <div class="subtitle"><strong><?php echo e($record->titulo); ?></strong></div>
            <div class="subtitle">Documento gerado em <?php echo e(now()->format('d/m/Y H:i')); ?></div>
        </div>

        <table class="meta">
            <tr>
                <td class="label">Título</td>
                <td><?php echo e($record->titulo); ?></td>
            </tr>
            <tr>
                <td class="label">Responsável pelo registro</td>
                <td><?php echo e($responsavel); ?></td>
            </tr>
            <tr>
                <td class="label">Data e hora da reunião</td>
                <td><?php echo e($record->data_reuniao?->format('d/m/Y H:i') ?? '-'); ?></td>
            </tr>
            <tr>
                <td class="label">Descrição</td>
                <td><?php echo e(filled($descricao) ? $descricao : '-'); ?></td>
            </tr>
        </table>
...
<?php /**PATH C:\laragon\www\cerape\resources\views\pdf\reuniao-ata-report.blade.php ENDPATH**/ ?>