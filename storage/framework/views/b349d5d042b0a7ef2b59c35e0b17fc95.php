...
<div id="<?php echo e($galleryId); ?>"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $visibleUrls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
