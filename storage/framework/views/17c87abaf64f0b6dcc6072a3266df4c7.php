<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
    <script>
        (() => {
            const statusUrl = <?php echo json_encode(route('browser-alerts.status'), 15, 512) ?>;
            const systemTitle = 'SISTEMA CERAPE';
            const titleSuffix = 'CERAPE';
            const chatPrefix = <?php echo json_encode(trim(config('chatify.routes.prefix', 'chatify'), '/')) ?>;
...
<?php /**PATH C:\laragon\www\cerape\resources\views/filament/portal/browser-title-alerts.blade.php ENDPATH**/ ?>